...
northBethesda:{
  ...
  recommendations:{status:"confirmed",rows:[
    {pri:"high",title:"Reduce honeydew melon prep quantities by 30–40%",
     body:"Honeydew melon accounts for 38.09 lbs of waste across two line items (honeydew melon at 29.93 lbs and honeydew melon chunks at 8.16 lbs), making it the single largest wasted ingredient by a wide margin. Immediately reduce prep volumes by 30–40% and monitor sell-through rates across the 3+ events where fruit medleys appeared on the menu before adjusting further.",
     support:"Honeydew melon (29.93 lbs) + honeydew melon chunks (8.16 lbs) = 38.09 lbs, representing ~33.7% of total waste (112.95 lbs) across the dataset."},
    {pri:"high",title:"Audit fruit platter menu items for right-sizing and repurposing",
     body:"Fruits represent 44.8% of all food waste by weight, and the top two most-frequently wasted menu items, 'Diced Cantaloupe | Honeydew | Pineapple' (3 events) and 'Sliced Cantaloupe | Pineapple | Honeydew' (2 events), are both fruit platters. Standardise smaller batch sizes for these items and establish a same-day repurposing protocol (smoothies, fruit infused water, dessert garnishes) to redirect leftover cut fruit before it becomes waste.",
     support:"Fruits account for 44.8% of waste by category, and fruit platter menu items appeared as top wasted items across 5 combined event occurrences."},
    {pri:"high",title:"Implement scrambled egg production scheduling in smaller batches",
     body:"Scrambled eggs are the second-largest wasted ingredient at 16.36 lbs and appeared on the waste log across 2 events, also linked to the recurring 'American Breakfast' menu item. Shift from large-batch cooking to rolling 15–20 minute small-batch production during service to reduce preconsumer egg waste, which contributes to the Kitchen department's leading 46.5% share of total waste.",
     support:"Scrambled eggs: 16.36 lbs wasted across 2 events; Kitchen department accounts for 46.5% of total waste; preconsumer waste is 61.1% of all waste by weight."},
    {pri:"med",title:"Target Kitchen department with prep yield training and par-level controls",
     body:"The Kitchen department generates 46.5% of total waste, the highest of any department, and preconsumer waste overall is 61.1%, indicating that over-prepping and trim loss are primary drivers. Introduce standardised par-level sheets and knife-skills/yield training focused on the top wasted ingredients (honeydew melon, scrambled eggs, green apple chunks at 9.98 lbs) to reduce waste before it ever reaches service.",
     support:"Kitchen: 46.5% of waste; preconsumer waste: 61.1% of 112.95 lbs total; green apple chunks: 9.98 lbs wasted."},
    {pri:"med",title:"Establish a cross-department leftover redistribution protocol",
     body:"Sweet Potato Hash and American Breakfast each appeared in waste logs across 2 events, and waste is distributed across four departments (Kitchen, Cafeteria, Restaurant, Banquet), suggesting siloed operations with no shared surplus system. Create an end-of-service communication channel between departments to redistribute surplus high-frequency items before disposal.",
     support:"Waste spans 4 departments (Kitchen 46.5%, Cafeteria 21.2%, Restaurant 17.7%, Banquet 14.7%)."},
    {pri:"high",costDriven:true,title:"Target pre-cut honeydew specifically, not just honeydew overall",
     body:"Ranked by weight, honeydew melon chunks are the smallest of the four named ingredients — but ranked by dollars they jump to second place, ahead of scrambled eggs, because pre-cut honeydew costs $3.95/lb against whole melon's $2.51/lb blended rate. Combined, whole and pre-cut honeydew account for $107.33 of the $149.08 in named-ingredient cost — 72% of it. Cut pre-cut honeydew batch sizes specifically, or shift more banquet prep to cutting whole melons in-house closer to service — the pre-cut premium currently costs more per pound wasted than the added prep labor would.",
     support:"Honeydew melon: 29.93 lbs, $75.11 ($2.51/lb). Honeydew melon chunks: 8.16 lbs, $32.22 ($3.95/lb). Combined $107.33, 72% of the $149.08 named-ingredient total."},
    {pri:"med",costDriven:true,title:"Fold protein cost into the Kitchen department's existing par-level review",
     body:"Proteins are 20.5% of North Bethesda's waste by weight but 28.3% of the week's food cost. Eggs, sausage and bacon shouldn't fall out of view just because fruit dominates the weight-ranked log — add a cost-ranked pass to the same par-level review already planned for the Kitchen department, so protein prep gets checked alongside fruit portioning rather than after it.",
